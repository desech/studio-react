...
module.exports = {
  ...
  injectIfFor (document) {
    for (const tag of document.querySelectorAll('[data-ss-properties]')) {
  ...
  clearnIfForProps (tag, props) {
    ...
    tag.setAttributeNS(null, 'data-ss-properties', JSON.stringify(props))
  },
