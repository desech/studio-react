...
module.exports = {
  ...
  getRenderBlock (body, fileType, data, lib) {
    ...
    return {
      ...
      html: this.regexHtmlRender(fileType, document, lib)
    }
  },
  ...
  injectComponentOverrides (document, overrides) {
    for (const node of document.querySelectorAll('[class*="e0"]')) {
      ...
      ParseOverride.injectOverride(node, ref, overrides[ref], this._component, document)
    }
  },
  ...
  regexHtmlRender (fileType, document, lib) {
