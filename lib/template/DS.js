...
export default class DS {
  ...
  static getDesechData (props, component) {
    ...
    this.setVariantOverrides(props?.dVariants, component?.variants, data)
  ...
  static setVariantOverrides (variants, variantOverrides, data) {
    if (!variants) return
    for (const [varName, varVal] of Object.entries(variants)) {
